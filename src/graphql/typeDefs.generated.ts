    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          directives: [],
          loc: { start: 436, end: 493 },
        },
      ],
      loc: { start: 293, end: 495 },
    },
    {
      kind: "ObjectTypeDefinition",
      name: {
      ...
      loc: { start: 497, end: 546 },
    },
    {
      kind: "ObjectTypeDefinition",
      name: { kind: "Name", value: "Product", loc: { start: 553, end: 560 } },
      interfaces: [],
      directives: [],
      fields: [
        {
          kind: "FieldDefinition",
          name: { kind: "Name", value: "id", loc: { start: 565, end: 567 } },
          arguments: [],
          type: {
            kind: "NonNullType",
            type: {
        ...
        {
          kind: "FieldDefinition",
          name: { kind: "Name", value: "name", loc: { start: 575, end: 579 } },
          arguments: [],
          type: {
            kind: "NonNullType",
            type: {
          ...
          directives: [],
          loc: { start: 575, end: 588 },
        },
        {
          kind: "FieldDefinition",
          name: { kind: "Name", value: "slug", loc: { start: 591, end: 595 } },
          arguments: [],
          type: {
            kind: "NonNullType",
            type: {
        ...
        {
          kind: "FieldDefinition",
          name: { kind: "Name", value: "price", loc: { start: 630, end: 635 } },
          arguments: [],
          type: {
            kind: "NonNullType",
            type: {
            ...
            loc: { start: 637, end: 641 },
          },
          directives: [],
          loc: { start: 630, end: 641 },
        },
        {
          kind: "FieldDefinition",
          name: { kind: "Name", value: "image", loc: { start: 644, end: 649 } },
          arguments: [],
          type: {
            kind: "NonNullType",
            type: {
        ...
        },
        {
          ...
          type: {
            ...
            loc: { start: 671, end: 687 },
          },
          directives: [],
          loc: { start: 661, end: 687 },
        },
      ],
      loc: { start: 548, end: 689 },
    },
    {
      kind: "ObjectTypeDefinition",
